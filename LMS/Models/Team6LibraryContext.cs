...
{
    public partial class Team6LibraryContext : DbContext
    {
        public Team6LibraryContext()
        {
        }

        public Team6LibraryContext(DbContextOptions<Team6LibraryContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u1200824;Password=1stdogPixie;Database=Team6Library");
            }
        }
